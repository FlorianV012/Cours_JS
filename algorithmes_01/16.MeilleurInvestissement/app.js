function meilleurInvestissement(arr) {
    ...
    console.log(date);
    return `Le meilleur coup à faire cette semaine était d'investir le ${jours[arr.indexOf(date[0][0])]} et de revendre le ${jours[arr.indexOf(date[0][1])]} pour un bénéfice de ${meilleurProfit}.`;
}
