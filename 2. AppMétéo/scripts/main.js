...
const CLEFAPI = "635b06eb24fcdfe5fcca158cc06bec4e";
let resultatsAPI;
...
function AppelAPI(long, lat) {
  fetch(
    ...
    .then((data) => {
      ...
      let heureAube = new Date(resultatsAPI.current.sunrise * 1000).getHours();
      let heureCrepuscule = new Date(resultatsAPI.current.sunset * 1000).getHours();
      ...
      // Icone dynamique
      if (heureActuelle >= heureAube && heureActuelle < heureCrepuscule) {
