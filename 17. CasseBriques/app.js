...
const rayonBalle = 10, barreHeight = 10, barreWidth = 75, nbCol = 8, nbRow = 5, largeurBrique = 75, hauteurBrique = 20, acceleration = 0.1;
    ...
    if (fin === false) {
        ...
        if (y + vitesseY > canvas.height - rayonBalle) {
            if (x > barreX && x < barreX + barreWidth) {
                ...
                fin = true;
                affichageScore.innerHTML = `Score : ${score} <br> Perdu ! <br> Cliques sur le casse-briques pour recommencer.`;
            }
        }
            ...
            if (b.statut === 1) {
                if (x > b.x && x < b.x + largeurBrique && y > b.y && y < b.y + hauteurBrique) {
                    ...
                    if (score === nbCol * nbRow) {
                        affichageScore.innerHTML = `Bravo ! <br> Cliques sur le casse-briques pour recommencer.`
                        fin = true;
                    }
                }
            }
